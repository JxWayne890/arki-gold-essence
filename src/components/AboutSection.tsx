  ...
  return <section className="bg-background py-24 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mx-auto max-w-4xl text-center mb-20 animate-fade-in-up">
          <p className="text-2xl md:text-3xl lg:text-4xl font-light leading-relaxed text-foreground">Where design artistry meets precision.</p>
        ...
        <div className="grid gap-12 md:grid-cols-3">
          ...
          return <div key={index} className="group text-center space-y-4 animate-fade-in-up" style={{
